# Salaries and Land Prices Reference

This document provides a comprehensive reference for all job salaries and land parcel prices in the Game of Life Town Hub simulation.

**Note:** All prices are in South African Rands (ZAR).
...
| Job Title | Salary (ZAR) | Company | Location | Notes |
|-----------|--------------|---------|----------|-------|
| **Mayor** | R 10,000.00 | Town Government | Town Hall | Highest authority position |
| **Lawyer** | R 8,000.00 | Town Government | Legal Office | Two positions available |
| **Town Planner** | R 7,500.00 | Town Government | Planning Office | Two positions available. Planners work together and must agree on major planning decisions. |
| **HR Director** | R 7,200.00 | Town Government | HR Office | |
| **Police Lieutenant** | R 7,000.00 | Town Police | Police Station | Two positions available |

### 💰 Finance

| Job Title | Salary (ZAR) | Company | Location | Notes |
|-----------|--------------|---------|----------|-------|
| **Chartered Accountant** | R 8,500.00 | Town Finance | Accounting Office | Two positions available |
| **Financial Manager** | R 7,800.00 | Town Finance | Finance Office | Two positions available |

### 🏗️ Infrastructure & Design

| Job Title | Salary (ZAR) | Company | Location | Notes |
|-----------|--------------|---------|----------|-------|
| **Architect** | R 8,000.00 | Town Design | Design Studio | |
| **Civil Engineer** | R 7,500.00 | Town Infrastructure | Engineering Office | |
| **Electrical Engineer** | R 7,500.00 | Town Infrastructure | Engineering Office | |

### 🎓 Education

| Job Title | Salary (ZAR) | Company | Location | Notes |
|-----------|--------------|---------|----------|-------|
| **School Principal** | R 9,000.00 | Town Education | School | |
| **Teacher** | R 6,000.00 | Town Education | School | |

### 🏥 Health

| Job Title | Salary (ZAR) | Company | Location | Notes |
|-----------|--------------|---------|----------|-------|
| **Doctor** | R 9,000.00 | Town Health | Hospital | |
| **Nurse** | R 5,500.00 | Town Health | Hospital | |

### 🏪 Business & Community

| Job Title | Salary (ZAR) | Company | Location | Notes |
|-----------|--------------|---------|----------|-------|
| **Retail Manager** | R 6,500.00 | Town Retail | Town Shop | |
| **Event Planner** | R 6,000.00 | Town Events | Event Office | |

### 📰 Media & Communication

| Job Title | Salary (ZAR) | Company | Location | Notes |
|-----------|--------------|---------|----------|-------|
| **Marketing Manager** | R 7,000.00 | Town Media | Marketing Office | |
| **Graphic Designer** | R 6,000.00 | Town Media | Design Studio | |
| **Journalist** | R 5,500.00 | Town News | News Office | |

### Salary Summary

- **Highest Salary:** R 10,000.00 (Mayor)
- **Lowest Salary:** R 5,500.00 (Nurse, Journalist)
- **Average Salary:** ~R 7,200.00
- **Total Jobs Available:** 20 positions
...
### Earning Money
1. **Apply for high-paying jobs** like Mayor (R 10,000), School Principal (R 9,000), or Doctor (R 9,000)
2. **Consider job requirements** - some positions have multiple openings (Lawyer, Town Planner, Police Lieutenant, Chartered Accountant, Financial Manager)
...
*All prices subject to change based on town economy and teacher settings.*
