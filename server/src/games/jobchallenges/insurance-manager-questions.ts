...
// EASY – Premium Basics (5% salary, broker fees, clinic/IT fees)
...
// MEDIUM – Combined Policies & Claims (multi-type premiums, payouts)
...
// HARD – Town-scale Risk (class payroll, treasury, claims/loss ratio)
...
// EXTREME – Portfolio & Treasury (payroll scale, reserves, multi-step)
