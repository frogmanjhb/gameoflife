...
export const easyQuestions: ElectricalEngineerQuestion[] = [
...
export const mediumQuestions: ElectricalEngineerQuestion[] = [
...
export const hardQuestions: ElectricalEngineerQuestion[] = [
...
export const extremeQuestions: ElectricalEngineerQuestion[] = [
