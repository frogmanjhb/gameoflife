...
export const easyQuestions: JournalistQuestion[] = [
...
export const mediumQuestions: JournalistQuestion[] = [
...
export const hardQuestions: JournalistQuestion[] = [
  ...
  { question: "Week 1: R10,000, Week 2: R12,000, Week 3: R11,000, Week 4: R13,200. Highest week-on-week growth (%)?", answer: 20, explanation: "Week 2: (12000−10000)/10000 = 20%; Week 4: (13200−11000)/11000 = 20%. Answer 20" },
  ...
  { question: "Quarter 1: R20,000, Q2: R22,000, Q3: R19,800, Q4: R24,200. Highest quarter-on-quarter growth (%)?", answer: 22.2, explanation: "Q2: 10%; Q4: (24200−19800)/19800 ≈ 22.2%" },
  ...
  { question: "Q1: 12,000, Q2: 13,200, Q3: 12,100, Q4: 14,520. Highest quarter growth (%)?", answer: 20, explanation: "Q2: 10%; Q4: (14520−12100)/12100 = 20%" },
  { question: "Start R1,000. +30% next period. New amount (R)?", answer: 1300, explanation: "1,000 × 1.30 = R1,300" },
  { question: "Month 1: 5,000, Month 2: 5,500, Month 3: 5,000, Month 4: 6,000. Highest month-on-month % growth?", answer: 20, explanation: "Month 2: 10%; Month 4: (6000−5000)/5000 = 20%" },
  ...
  { question: "Week 1: 8,000, Week 2: 9,600, Week 3: 8,000, Week 4: 10,000. Highest week-on-week growth (%)?", answer: 25, explanation: "Week 2: 20%; Week 4: (10000−8000)/8000 = 25%" },
...
export const extremeQuestions: JournalistQuestion[] = [
  ...
  { question: "Business A: Revenue R20,000, Profit R5,000. Business B: Revenue R15,000, Profit R6,000. Which is more profitable by percentage? Answer the higher profit margin (%).", answer: 40, explanation: "A: 5000/20000=25%. B: 6000/15000=40%. Answer 40" },
