// Lawyer – Legal Reasoning Challenge (Case Review)
...
export const easyQuestions: LawyerQuestion[] = [
...
export const mediumQuestions: LawyerQuestion[] = [
...
export const hardQuestions: LawyerQuestion[] = [
...
export const extremeQuestions: LawyerQuestion[] = [
