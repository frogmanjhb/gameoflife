...
exports.getInsuranceManagerQuestion = getInsuranceManagerQuestion;
...
function getInsuranceManagerQuestion(difficulty) {
    let questions;
    switch (difficulty) {
        case 'easy':
...
//# sourceMappingURL=insurance-manager-questions.js.map