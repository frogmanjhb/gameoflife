 ...
 */
router.post('/factory-reset', auth_1.authenticateToken, (0, auth_1.requireRole)(['teacher']), [(0, express_validator_1.body)('confirm').isString().withMessage('Confirm is required')], async (req, res) => {
