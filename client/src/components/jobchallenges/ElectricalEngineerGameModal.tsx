...
const ElectricalEngineerGameModal: React.FC<ElectricalEngineerGameModalProps> = ({
  ...
  const startGame = async (diff: Difficulty) => {
    try {
      setDifficulty(diff);
      const response = await electricalEngineerGameApi.startGame({ difficulty: diff });
          ...
          <div className="p-6 space-y-4">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-400">
                {gameStatus?.remaining_plays ?? 0} / {gameStatus?.daily_limit ?? 3} power allocation reviews remaining today
              </p>
            </div>
