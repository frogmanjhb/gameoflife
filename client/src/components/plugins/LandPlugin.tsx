    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-6 text-white">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Land & Property</h1>
            <p className="text-primary-100">Property Registry System</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Land Registry</h2>
        <p className="text-gray-600 mb-4">
          This system is part of the Game of Life Town Hub.
        </p>
        <p className="text-sm text-gray-500">
          Land and property management will be available here soon.
        </p>
      </div>
    </div>
  );
