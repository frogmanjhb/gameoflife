// Teacher – Learning Support Challenge (Teaching Cycle) – client, same as server
...
const easyQuestions: TeacherQuestion[] = [
...
const mediumQuestions: TeacherQuestion[] = [
...
const hardQuestions: TeacherQuestion[] = [
...
const extremeQuestions: TeacherQuestion[] = [
