// Nurse – Health Support Challenge (Health Check Cycle) – client, same as server
...
const easyQuestions: NurseQuestion[] = [
...
const mediumQuestions: NurseQuestion[] = [
...
const hardQuestions: NurseQuestion[] = [
...
const extremeQuestions: NurseQuestion[] = [
