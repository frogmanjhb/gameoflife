// Retail Manager – Shop Profit Challenge (Trading Day Review) – client, same as server
...
const easyQuestions: RetailManagerQuestion[] = [
...
const mediumQuestions: RetailManagerQuestion[] = [
...
const hardQuestions: RetailManagerQuestion[] = [
...
const extremeQuestions: RetailManagerQuestion[] = [
